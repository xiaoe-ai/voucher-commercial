...
alter table public.xiaoe_bridge_audit enable row level security;
...
create index if not exists idx_xiaoe_bridge_audit_created_at
  on public.xiaoe_bridge_audit(created_at desc);
