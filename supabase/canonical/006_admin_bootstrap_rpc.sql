...
-- Layer: 006 First Admin bootstrap RPC
...
begin
  ...
  if v_admin_partner_id is null then
    ...
    update public.partners set status='active' where id=v_admin_partner_id;
  end if;
  ...
  set enabled=false, consumed_at=now(), updated_at=now()
